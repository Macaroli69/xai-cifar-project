...
# First two conv layers find edges and shapes, then pooling layers shrink the image,
# then fully connected layers flatten and classify the image
...
class SimpleCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        # reshape is used instead of view so it also works with non-contiguous tensors
